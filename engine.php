	...
	<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
		...
		<main role="main" class="container">
    		<div class="starter-template"> <br><br><br>
				...
				<p class="lead">Masukkan gambar<br>  Click <b>Upload</b>,  <b>analisis gambar</b> pada tabel.</p>
				<span class="border-top my-3"></span>
			</div>
		<div class="mt-4 mb-2">
			<form class="d-flex justify-content-lefr" action="engine.php" method="post" enctype="multipart/form-data">
